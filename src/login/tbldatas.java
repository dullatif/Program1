 ...
 * @author Latif
 */
public class tbldatas extends javax.swing.JFrame {
    private Connection conn = new konek().connect();
    private DefaultTableModel tabmode;
    /**
     * Creates new form tbldatas
     */
    public tbldatas() {
        initComponents();
        datatable();
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/icons8_cancel_32px.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tbldatas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
